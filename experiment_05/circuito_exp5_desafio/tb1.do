...
add wave -noupdate -color Red -height 30 /circuito_exp5_tb1/nivel_in
...
add wave -noupdate -color Coral -height 30 /circuito_exp5_tb1/db_nivel_out
add wave -noupdate -divider FD
add wave -noupdate -color Khaki -height 30 /circuito_exp5_tb1/dut/s_memoria
add wave -noupdate -color Khaki -height 30 /circuito_exp5_tb1/dut/FD/s_botoes
add wave -noupdate -color Khaki -height 30 -radix hexadecimal /circuito_exp5_tb1/dut/s_contagem
add wave -noupdate -divider UC
add wave -noupdate -color Magenta -height 30 -radix hexadecimal /circuito_exp5_tb1/dut/s_limite
