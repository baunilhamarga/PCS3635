...
add wave -noupdate -height 30 -radix decimal /jogo_desafio_memoria_tb1/clockPeriod
...
add wave -noupdate -color Red -height 30 /jogo_desafio_memoria_tb1/nivel_in
add wave -noupdate -divider {Deteccao de jogada}
add wave -noupdate -color Gold -height 30 /jogo_desafio_memoria_tb1/db_tem_jogada_out
add wave -noupdate -color Magenta -height 30 /jogo_desafio_memoria_tb1/dut/FD/jogada_feita
...
add wave -noupdate -color Coral -height 30 /jogo_desafio_memoria_tb1/db_igualE_out
add wave -noupdate -color Coral -height 30 /jogo_desafio_memoria_tb1/db_igualL_out
add wave -noupdate -color Coral -height 30 /jogo_desafio_memoria_tb1/db_nivel_out
...
add wave -noupdate -color Magenta -height 30 -radix hexadecimal /jogo_desafio_memoria_tb1/dut/s_limite
add wave -noupdate -color Magenta -height 30 -radix hexadecimal /jogo_desafio_memoria_tb1/dut/UC/Eatual
add wave -noupdate -color Magenta -height 30 /jogo_desafio_memoria_tb1/db_contaL_out
add wave -noupdate -color Magenta -height 30 /jogo_desafio_memoria_tb1/db_timeout_out
