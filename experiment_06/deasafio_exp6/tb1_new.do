...
add wave -noupdate -color {Medium Orchid} -height 30 /jogo_desafio_memoria_tb1/leds_out
...
add wave -noupdate -color Khaki -height 30 /jogo_desafio_memoria_tb1/dut/FD/s_sequencia
add wave -noupdate -divider UC
add wave -noupdate -radix ascii -height 30 /jogo_desafio_memoria_tb1/dut/UC/Eatual_str
add wave -noupdate -color {Pale Green} /jogo_desafio_memoria_tb1/dut/UC/controla_leds
add wave -noupdate -divider Depuracao
add wave -noupdate -color Blue -height 30 /jogo_desafio_memoria_tb1/db_chavesIgualMemoria_out
add wave -noupdate -color Blue -height 30 /jogo_desafio_memoria_tb1/db_enderecoIgualSequencia_out
add wave -noupdate -color Blue -height 30 /jogo_desafio_memoria_tb1/db_fimS_out
add wave -noupdate -color Blue -height 30 /jogo_desafio_memoria_tb1/db_seletor_memoria_out
