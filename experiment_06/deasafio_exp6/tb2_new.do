...
add wave -noupdate -color Red -height 30 /jogo_desafio_memoria_tb2/memoria_in
...
add wave -noupdate -color {Medium Orchid} -height 40 /jogo_desafio_memoria_tb2/leds_out
...
add wave -noupdate -color Khaki /jogo_desafio_memoria_tb2/dut/FD/s_sequencia
add wave -noupdate -divider UC
add wave -noupdate -radix ascii /jogo_desafio_memoria_tb2/dut/UC/Eatual_str
add wave -noupdate -color {Pale Green} /jogo_desafio_memoria_tb2/dut/UC/controla_leds
add wave -noupdate -divider Depuracao
add wave -noupdate -color Blue /jogo_desafio_memoria_tb2/db_chavesIgualMemoria_out
add wave -noupdate -color Blue /jogo_desafio_memoria_tb2/db_enderecoIgualSequencia_out
add wave -noupdate -color Blue /jogo_desafio_memoria_tb2/db_fimS_out
add wave -noupdate -color Blue /jogo_desafio_memoria_tb2/db_seletor_memoria_out
