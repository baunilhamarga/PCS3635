...
add wave -noupdate -color Khaki /jogo_desafio_memoria_tb3/dut/FD/s_sequencia
add wave -noupdate -divider UC
add wave -noupdate -radix ascii /jogo_desafio_memoria_tb3/dut/UC/Eatual_str
add wave -noupdate -color {Pale Green} /jogo_desafio_memoria_tb3/dut/UC/controla_leds
